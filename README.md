...
The current macOS Apple silicon, Windows, and Debian-family Linux release is **1.45.0+airc110**. Each published installer ships with checksums,
...
restarts. See the
[airc110 release notes](https://github.com/AiRC-ai/AiRC-Orchestration/releases/tag/v1.45.0%2Bairc110)
for verification details.

| Platform | Architecture | Download |
| --- | --- | --- |
| macOS | Apple silicon (`arm64`) | [`AiRC-1.45.0+airc110-macOS-arm64.zip`](https://github.com/AiRC-ai/AiRC-Orchestration/releases/download/v1.45.0%2Bairc110/AiRC-1.45.0+airc110-macOS-arm64.zip) |
| Windows | x86_64 (`x64`) | [`AiRC-1.45.0+airc110-Setup.exe`](https://github.com/AiRC-ai/AiRC-Orchestration/releases/download/v1.45.0%2Bairc110/AiRC-1.45.0+airc110-Setup.exe) |
| Debian-family Linux | x86_64 (`amd64`) | [`airc_1.45.0+airc110_amd64.deb`](https://github.com/AiRC-ai/AiRC-Orchestration/releases/download/v1.45.0%2Bairc110/airc_1.45.0+airc110_amd64.deb) |

The macOS `airc110` build is signed with a Developer ID certificate, notarized by Apple, and carries a stapled notarization ticket. Windows uses a one-click, per-user installer; this manually published build is currently unsigned, so Windows SmartScreen may request confirmation on first launch. The release manifest records that signing state explicitly.
...
- Windows PE integrity, checksum, runtime, and Authenticode-state verification when a Windows installer is included
