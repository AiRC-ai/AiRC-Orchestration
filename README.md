...
The current Beta release is **1.45.0+airc47**. Each installer ships with verification files on the [Releases](https://github.com/AiRC-ai/AiRC-Orchestration/releases) page.

This release strengthens multi-window and stale-task recovery. A task running in another AiRC window now has one clear ownership state, keeps drafts editable, blocks unsafe duplicate sends, and unlocks immediately when the owning window closes. Deleting an open task from another window removes it from history and returns the matching chat to Home without a failed-task screen, Orchestrator error, or retry loop. It also retains the long-conversation, automation, Computer Use, provider, Keychain-isolation, and complete AiRC-branding improvements from the preceding 1.45 builds. See the [full release notes](https://github.com/AiRC-ai/AiRC-Orchestration/releases/tag/v1.45.0%2Bairc47) for verification and installation details.

| Platform | Architecture | Download |
| --- | --- | --- |
| macOS | Apple silicon (`arm64`) | [`AiRC-1.45.0+airc47-macOS-arm64.zip`](https://github.com/AiRC-ai/AiRC-Orchestration/releases/download/v1.45.0%2Bairc47/AiRC-1.45.0+airc47-macOS-arm64.zip) |
| Debian-family Linux | x86_64 (`amd64`) | [`airc_1.45.0+airc47_amd64.deb`](https://github.com/AiRC-ai/AiRC-Orchestration/releases/download/v1.45.0%2Bairc47/airc_1.45.0+airc47_amd64.deb) |
